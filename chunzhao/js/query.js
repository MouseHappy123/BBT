$(".back").click(function () {
    setTimeout(function () { window.location.assign(htmlPath1); }, 400);
});
$(".query").click(function () {
    var name = $("#name").val();
    var phone = $("#phone").val();
    if (Is('chinese', name, 0) && Is('phone', phone, 0)) {
        $.ajax({
            type: "POST",
            url: phpPath2,
            data: { name, phone },
            ...
            success: function (res) {
                if (!res.errcode) {
                    $("#result").html("<div id=\"mainForm\"style=\"height:100%;\">" +
                        ...
                        "<div id=\"key\">宿舍" +
                        "<input id=\"dorm1\" class=\"first\"type=\"text\" value=\"" + res.dorm + "\" maxlength=\"10\"></div>" +
                        "<div id=\"key\">手机" +
                        ...
                        "<br/>" +
                        "<br/>" +
                        "<img src=\"part3.png\"style=\"width:100%;\"></img>" +
                        "<script src=\"./change.js\"></script>" + "</div></div>");
                }
